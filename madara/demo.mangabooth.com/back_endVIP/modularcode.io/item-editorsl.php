...
<?php 
            ...
            if (isset($_POST['luu'])) {
               ...
               if($typeA != "image/jpeg" && $typeA != "image/jpg" && $typeA != "image/png"){
                    ...
                    $sql="insert into sliders values('','$nameA','$title','$status','$order')"; 
                $kq=$conn->exec($sql);
                if($kq==1){
            ...
            <div class="app" id="app">
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Thêm slide <span class="sparkline bar" data-type="bar"></span>
                        </h3>
                    </div>
                    <form name="item" method="POST" enctype="multipart/form-data">
                        <div class="card card-block">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder="" name="title">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right" > Số thứ tự : </label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control boxed" placeholder="" min="0" name="order">
                                </div>
                            </div>
                            <!-- <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Đường dẫn : </label>
                                <div class="col-sm-10">
                            ...
                            <input type="radio" name="status" style="margin-left: 20px;" value="On" checked=""> On 
                            <input type="radio" name="status" style="margin-left: 50px;" value="Off" checked="" > Off <br>
                           </div>
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Ảnh slide: </label>
                                <div class="col-sm-10">
