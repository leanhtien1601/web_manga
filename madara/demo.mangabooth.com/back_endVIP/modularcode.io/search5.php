        ...
        <div class="app" id="app">
            <header class="header">
                ...
                <div class="header-block header-block-search">
                    <form role="search" action="search5.php" method="get">
                        <div class="input-container">

                            <input type="text" placeholder="Gõ tên tài khoản" name="search">
            ...
            // Nếu $search rỗng thì báo lỗi, tức là người dùng chưa nhập liệu mà đã nhấn submit.
                                ...
                                {
                                    $query = "select * from account where user like '%$search%'";
                                    $kq=$conn->query($query);
                                    if ( $search !="" ) {
                                        foreach ($kq as $key  => $row) {
                                             ?>
