...
<!-- Mirrored from modularcode.io/modular-admin-html/cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Nov 2019 16:07:46 GMT -->
                        ...
                        foreach ($kq as $key => $row) {
                            ...
                            <div class="row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 form-control-label text-xs-right"> Logo trang: </label>
                                    <div class="col-sm-10">
                                        <div class="images-container" >
                                            <div class="image-container" style="background-color: #dc3545">
                                                <div class="image" style="background-image:url('../../images/<?php echo $row['logo'] ?>');background-size: auto;width: 200px;"></div>
                                            </div>
                                ...
                                <div class="item-actions-block">
                                    <ul class="item-actions-list">
                                        <li style="list-style-type: none;float:right">
                                            <a class="remove" onclick="confirm('Bạn có chắc muốn xóa không?')" href="item-removegd.php?idremove=<?php echo $row['id']; ?>">
                                                <i class="fa fa-trash-o "></i>
                                            </a>
                                        </li>
                                        <li style="list-style-type: none;float:right; margin-right:30px">
                                            <a class="edit" href="item-editorgd.php?idedit=<?php echo $row['id']; ?>">
