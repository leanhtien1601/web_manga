                            ...
                            <li class="item">
                                <div class="item-row">
                                    ...
                                    <div class="item-col item-col-author">
                                        <a href="item-editortl1.php?masua=<?php echo $row['id']; ?>" style="text-decoration: none;"> <h4 class="item-title">Cập nhật</h4></a>
                                    </div>
                                        ...
                                        <div class="item-actions-dropdown">
                                            ...
                                            <div class="item-actions-block">
                                                <ul class="item-actions-list">
                                                    <li>
                                                        <a class="remove" href="xoatl.php?maxoa=<?php echo $row['id']; ?>" >
