...
<head>
    ...
    if (isset($_GET['masua'])) {
        $masua=$_GET['masua'];
        $sql="select * from kind where id = $masua";
        $kq=$conn->query($sql)->fetch();
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Cập nhật danh mục  <span class="sparkline bar" data-type="bar"></span>
                        </h3>
                    </div>
                ...
                if (isset($_POST['luu'])) {
                     $name=$_POST['name'];
                     $sql="update kind set name='$name' where id='$masua' ";
                     $kq=$conn->prepare($sql);
                            if ($kq->execute()) {
                                  echo " Thành công";
                            } else {
