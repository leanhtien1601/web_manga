...
<head>
        ...
        <title>Cập nhật giao diện</title>
    ...
    <?php 
        ...
        if(isset($_GET['idedit'])){
            $idedit=$_GET['idedit'];
            $sqlsua="select * from themes where id='$idedit'";
            ...
            <div class="app" id="app">
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Cập nhật giao diện <span class="sparkline bar" data-type="bar"></span>
                        </h3>
                    </div>
                    <form name="item" method="POST" enctype="multipart/form-data">
                        <div class="card card-block">
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Thông tin: </label>
                                <div class="col-sm-10">
                                    <input type="text" name="footer" value="<?php echo $kqsua['footer'] ?>" class="form-control boxed" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Ảnh logo: </label>
                                <div class="col-sm-10">
                                    <div class="images-container">
                                        <div class="image-container" style="background-color: #dc3545">
                                            <div class="image" style="background-image:url('../../images/<?php echo $kqsua['logo'] ?>'); background-size: auto;width: 200px"></div>
                                        </div>
                    ...
                    <?php 
                        ...
                        if(isset($_POST['sb'])){
                            ...
                            if(empty($_FILES['logo']['name'])){
                                $sql2="update themes set footer='$footer' where id='$idedit'";
                            }
                            else{
                                $nameA=$_FILES['logo']['name'];
                                $tmpA=$_FILES['logo']['tmp_name'];
                                $typeA=$_FILES['logo']['type'];
                                if($typeA != "image/jpeg" && $typeA != "image/jpg" && $typeA != "image/png"){
                                    ...
                                    $sql2="update themes set footer='$footer', logo='$nameA' where id='$idedit'";
                                }
