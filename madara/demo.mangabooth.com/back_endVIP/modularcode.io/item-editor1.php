...
?>
    <?php 
        ...
        if(isset($_GET['idedit'])){
            $idedit=$_GET['idedit'];
            $sqlsua="select * from manga where id='$idedit'";
...
<?php 
                        ...
                        if(isset($_POST['sb'])){
                            ...
                            if(empty($_FILES['images']['name'])){
                                $sql2="update manga set name='$name', content='$content',id_cate='$cate',id_kind='$kind' where id='$idedit'";
                            }
                            else{
                                ...
                                if($typeA != "image/jpeg" && $typeA != "image/jpg" && $typeA != "image/png"){
                                    ...
                                    $sql2="update manga set name='$name', content='$content',images='$nameA',cate='$cate',kind='$kind' where id='$idedit'";
                                }
                                
                            }
                            $kq2=$conn->prepare($sql2);
            if($kq2->execute()){
            ...
            <div class="app" id="app">
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Cập nhật truyện <span class="sparkline bar" data-type="bar"></span>
                        </h3>
                    </div>
                    <form name="item" method="POST" enctype="multipart/form-data">
                        <div class="card card-block">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" value="<?php echo $kqsua['name'] ?>" class="form-control boxed" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="wyswyg">
                                        <textarea name="content" style="width: 100%;height: 300px;display:all ;"><?php echo $kqsua['content']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    foreach ($kq as $key => $value) {
                                        ...
                                        <option value="<?php echo $value['id']; ?>" <?php if($value['id']==$kqsua['id_kind']){
                        echo "selected";
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    foreach ($kq1 as $key => $value1) {
                                        ...
                                        <option value="<?php echo $value1['id']; ?>" <?php if($value1['id']==$kqsua['id_cate']){
                        echo "selected";
                                ...
                                <div class="col-sm-10">
                                    <div class="images-container">
                                        <div class="image-container">
                                            <div class="image" style="background-image:url('../../images/<?php echo $kqsua['images'] ?>')"></div>
                                        </div>
