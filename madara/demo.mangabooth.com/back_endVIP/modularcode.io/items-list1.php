...
if(isset($_GET['id_chap'])){
    ...
    $sql_chap = "select * from manga where id = '$id_chap'";
                            ...
                            <div class="sidebar-container">
                                ...
                                <nav class="menu">
                                    <ul class="sidebar-menu metismenu" id="sidebar-menu">
                                        ...
                                        <!-- <li>
                                            <a href="items-list.php"> Phân quyền tài khoản  </a>
                                        </li> -->
                ...
                <article class="content items-list-page">
                    <div class="title-search-block">
                        <div class="title-block">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="title"> Bình luận <!-- <a href="item-editor.php" class="btn btn-primary btn-sm rounded-s"> Thêm mới</a> -->
                                        <!--
                                        -->
                    ...
                    <div class="card items">
                        <ul class="item-list striped">
                            ...
                            <?php 
                            include '../../db.php';
                            $sql="select * from chapters where id_manga='$id_chap'";
                            $kq=$conn->query($sql);
                            foreach ($kq as $key => $row) {
                                ?>
                                ...
                                <li class="item">
                                    <div class="item-row">
                                        ...
                                        <div class="item-col fixed item-col-img md">
                                            ...
                                            <div><h4 class="item-title"><?php echo $key+1; ?></h4></div>
                                        ...
                                        <div class="item-col fixed pull-left item-col-title">
                                            ...
                                            <div>
                                                ...
                                                <h4 class="item-title"><?php echo $kq_chap['name']; ?></h4>
                                        ...
                                        <div class="item-col item-col-date">
                                            <div class="no-overflow"><?php echo $kq_chap['date']; ?></div>
                                        </div>
                                            ...
                                            <div class="item-actions-dropdown">
                                                ...
                                                <div class="item-actions-block">
                                                    <ul class="item-actions-list">
                                                        <li>
                                                            <a class="remove" onclick="confirm('Bạn có chắc muốn xóa không?')" href="item-removechap.php?idremove=<?php echo $row['id'] ?>" >
