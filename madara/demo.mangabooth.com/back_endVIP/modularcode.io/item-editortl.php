...
?><!doctype html>
 <?php 
    ...
    if (isset($_POST['luu'])) {
       $ten=$_POST['name'];
       $sql="insert into kind values('','$ten')";
        $kq=$conn->exec($sql);
       if ($kq==1) {
            ...
            <div class="app" id="app">
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Thêm thể loại mới <span class="sparkline bar" data-type="bar"></span>
                        </h3>
                    </div>
                    <form name="item" method="POST" enctype="multipart/form-data">
                        <div class="card card-block">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder=""name='name' required="">
                                </div>
                            </div>
