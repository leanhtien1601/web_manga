                            ...
                            <li class="item item-list-header">
                                <div class="item-row">
                                    ...
                                    <div  class="item-col item-col-header item-col-sales">
                                        <div>
                                            <span style="float:left">Số điện thoại</span>
                                        </div>
                                    </div>
                                    
                                    <div class="item-col item-col-header item-col-category">
                                        <div class="no-overflow">
                                            <span style="margin-left: 27px">Nội dung</span>
                                        </div>
                                    </div>
                                ...
                                <div class="item-row">
                                    ...
                                    <div  class="item-col fixed pull-left item-col-title">
                                            <div>
                                                ...
                                                <h4  class="item-title"> <?php echo $row['email']; ?> </h4>
                                        ...
                                        <div class="item-actions-dropdown">
                                            ...
                                            <div class="item-actions-block">
                                                <ul class="item-actions-list">
                                                    <li>
                                                        <a class="remove" onclick="confirm('Bạn có chắc muốn xóa không?')" href="item-removelh.php?idremove=<?php echo $row['id']; ?>">
