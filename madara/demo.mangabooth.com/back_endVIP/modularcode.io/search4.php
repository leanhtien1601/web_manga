    ...
    <body>
        <div class="main-wrapper">
            <div class="app" id="app">
                <header class="header">
                    ...
                    <div class="header-block header-block-search">
                       <form role="search" action="search4.php" method="get">
                        <div class="input-container">

                            <input type="text" placeholder="Gõ tên tác giả" name="search">
                ...
                <article class="content items-list-page">
                    <div class="title-search-block">
                        <div class="title-block">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="title"> Tác giả <a href="item-editortg.php" class="btn btn-primary btn-sm rounded-s"> Thêm mới</a>
                                        <!--
                 -->
            ...
            // Nếu $search rỗng thì báo lỗi, tức là người dùng chưa nhập liệu mà đã nhấn submit.
                                ...
                                {
                                    $query = "select * from authors where name like '%$search%'";
                                    $kq=$conn->query($query);
                                    if ( $search !="" ) {
                                    ...
                                    <div class="item-col item-col-author">
                                        ...
                                        <div class="no-overflow">
                                            <a href="" style="text-decoration: none;">
                                                <h4 class="item-title"> <?php echo $value['nation']; ?> </h4>
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="item-actions-dropdown">
                                            ...
                                            <div class="item-actions-block">
                                                <ul class="item-actions-list">
                                                    <li>
                                                        <a class="remove" href="xoatg.php?maxoa=<?php echo $value['id'] ?>" >
