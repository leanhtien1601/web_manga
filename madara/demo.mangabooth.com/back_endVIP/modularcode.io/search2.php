            ...
            <div class="app" id="app">
                <header class="header">
                    ...
                    <div class="header-block header-block-search">
                         <form role="search" action="search2.php" method="get">
                ...
                <article class="content items-list-page">
                    <div class="title-search-block">
                        <div class="title-block">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="title"> Danh mục<a href="item-editorqc.php" class="btn btn-primary btn-sm rounded-s"> Thêm mới</a>
                                        <!--
				 -->
                                ...
                                <div class="item-row">
                                   ...
                                   <div class="item-col fixed pull-left item-col-title">
                                    ...
                                    <div class="item-col item-col-author">
                                        ...
                                        <div class="no-overflow">
                                            <a href="item-editorqc1.php?masua=<?php echo $value['id']; ?>" style="text-decoration: none;">Cập nhật</a>
                                        </div>
                                    </div>
