...
if(isset($_GET['id_cmt'])){
    $id_cmt = $_GET['id_cmt'];
    $sql_cmt = "select * from manga where id = '$id_cmt'";
                ...
                <article class="content items-list-page">
                    ...
                    <div class="card items">
                        <ul class="item-list striped">
                            ...
                            <?php 
                            include '../../db.php';
                            $sql="select * from comments where id_manga='$id_cmt'";
                            $kq=$conn->query($sql);
                            foreach ($kq as $key => $row) {
                                ?>
                                            ...
                                            <div class="item-actions-dropdown">
                                                ...
                                                <div class="item-actions-block">
                                                    <ul class="item-actions-list">
                                                        <li>
                                                            <a class="remove" onclick="confirm('Bạn có chắc muốn xóa không?')" href="item-removecmt.php?idremove=<?php echo $row['id'] ?>" >
