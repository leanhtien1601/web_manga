            ...
            <div class="app" id="app">
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Thêm chương mới <span class="sparkline bar" data-type="bar"></span>
                        </h3>
                    </div>
                    <form name="item" method="POST" enctype="multipart/form-data">
                        <div class="card card-block">
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Tên chương: </label>
                                <div class="col-sm-10">
                                    <input type="text" name="name" class="form-control boxed" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="manga" class="c-select form-control boxed">
                                        <option>Chọn truyện cần thêm</option>
                                        <?php 
                                            include '../../db.php';
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="order" class="form-control boxed" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    include '../../db.php';
                        if(isset($_POST['sb'])){
                            ...
                            $order=$_POST['order'];
                            $date=date("y/m/d");
                            $sql1="insert into chapters values('','$name','$content','$manga','$order','$date')";
                            $kq1=$conn->exec($sql1);
                            if($kq1==1){
