                    ...
                    <div class="card items">
                        <ul class="item-list striped">
                            ...
                            foreach ($kq as $key => $value) {
                                $value_cmt = $value['id'];
                                $sql_cmt = "select id_manga, count(id_manga) as count_cmt from comments where id_manga = '$value_cmt'";
                                $kq_cmt=$conn->query($sql_cmt)->fetch();
                                if($value_cmt == $kq_cmt['id_manga']){
                                    ?>
                                            ...
                                            <div class="item-col fixed pull-left item-col-title">
                                                ...
                                                <div>
                                                    <!-- <a href="item-editor.php" class=""> -->
                                                        <h4 class="item-title"><?php echo $key+1; ?></h4>
                                                        <!-- </a> -->
                                                    </div>
                                                </div>
                                                ...
                                                <div class="item-col item-col-category no-overflow">
                                                    ...
                                                    <div class="no-overflow"><?php echo $value['name']; ?></div>
                                                    
                                                </div>
                                                <div class="item-col item-col-author">
                                                    
                                                    <div class="no-overflow"><?php echo $kq_cmt['count_cmt']; ?></div>
                                                </div>
                                                <div class="item-col item-col-date">
                                                    <div class="item-heading">Chi tiết</div>
                                                    <div class="no-overflow"><a href="items-listbl1.php?id_cmt=<?php echo $value_cmt ?>"> Xem</a></div>
                                                </div>
