...
?>
 <?php 
        ...
        if(isset($_GET['idedit'])){
            $idedit=$_GET['idedit'];
            $sqlsua="select * from account where id='$idedit'";
...
<?php 
                    include '../../db.php';
                        if(isset($_POST['sb'])){
                            ...
                            $sql1="update account set authorize='$authorize' where id='$idedit'";
                            $kq1=$conn->prepare($sql1);
                            if($kq1->execute()){
...
<!-- Mirrored from modularcode.io/modular-admin-html/item-editor.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Nov 2019 16:07:45 GMT -->
            ...
            <div class="app" id="app">
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Tài khoản <span class="sparkline bar" data-type="bar"></span>
                        </h3>
                    </div>
                    <form name="item" method="POST" enctype="multipart/form-data">
                        <div class="card card-block">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Quyền: </label>
                                <div class="col-sm-10">
                                    <?php 
                                if($kqsua['authorize'] == 'Admin'){
                                    ?>
                                    <input type="radio" name="authorize" required="" value="Admin" checked="">Admin <input style="margin-left:30px" type="radio" name="authorize" required="" value="Thành viên">Thành viên  
                                    <?php 
                                }else if($kqsua['authorize'] == 'Thành viên'){
                                    ?>
                                    <input type="radio" name="authorize" required="" value="Admin" >Admin <input style="margin-left:30px" type="radio"  name="authorize" required="" checked="" value="Thành viên">Thành viên  
                                <?php
