...
?><!doctype html>
   <?php 
    ...
    if (isset($_POST['luu'])) {
        $nation=$_POST['nation'];
    $ten=$_POST['name'];
    $sql="insert into authors values('','$nation','$ten')";
    $kq=$conn->exec($sql);
       if ($kq==1) {
            ...
            <div class="app" id="app">
                ...
                <article class="content item-editor-page">
                    <div class="title-block">
                        <h3 class="title"> Thêm tác giả <span class="sparkline bar" data-type="bar"></span>
                        </h3>
                    </div>
                    <form name="item" method="POST" enctype="multipart/form-data">
                        <div class="card card-block">
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Tên tác giả: </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder="Nhập tên tác giả" name="name">

                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label text-xs-right"> Tên quốc gia: </label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control boxed" placeholder="Nhập tên quốc gia" name="nation">
