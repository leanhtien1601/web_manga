...
<head>
	...
	if(isset($_GET['id_cate'])){
		...
		$sql_cate = "select * from categories where id = '$id_cate'";
		$kq_cate = $conn->query($sql_cate)->fetch();
	}
	?>

	<title><?php echo $kq_cate['name']; ?></title>
													...
													<ul class="nav navbar-nav main-navbar"><li id="menu-item-27" class="menu-item menu-item-type-taxonomy menu-item-object-wp-manga-genre menu-item-51"><a href="../../index.php" aria-current="page">TRANG CHỦ</a>
														...
														foreach ($kq as $key => $value) {
															...
															<li id="menu-item-75" class="menu-item menu-item-type-taxonomy menu-item-object-wp-manga-genre menu-item-51">
																<a href="index.php?id_cate=<?php echo $value['id']?>">
																	<?php echo $value['name']; ?>
																</a>
															</li>
															<?php 
														...
														?>
														<li id="menu-item-110" class="menu-item menu-item-type-taxonomy menu-item-object-wp-manga-genre menu-item-51"><a href="../../about-us/index.php">LIÊN HỆ</a></li>
													</div>
...
<div class="site-content">
	<script type="text/javascript">
		var manga_args = {"wp-manga-genre":"action","error":"","m":"","p":0,"post_parent":"","subpost":"","subpost_id":"","attachment":"","attachment_id":0,"name":"","pagename":"","page_id":0,"second":"","minute":"","hour":"","day":0,"monthnum":0,"year":0,"w":0,"category_name":"","tag":"","cat":"","tag_id":"","author":"","author_name":"","feed":"","tb":"","paged":1,"meta_key":"_latest_update","meta_value":"","preview":"","s":"","sentence":"","title":"","fields":"","menu_order":"","embed":"","category__in":[],"category__not_in":[],"category__and":[],"post__in":[],"post__not_in":[],"post_name__in":[],"tag__in":[],"tag__not_in":[],"tag__and":[],"tag_slug__in":[],"tag_slug__and":[],"post_parent__in":[],"post_parent__not_in":[],"author__in":[],"author__not_in":[],"ignore_sticky_posts":false,"suppress_filters":false,"cache_results":true,"update_post_term_cache":true,"lazy_load_term_meta":true,"update_post_meta_cache":true,"post_type":"wp-manga","posts_per_page":12,"nopaging":false,"comments_per_page":"50","no_found_rows":false,"taxonomy":"wp-manga-genre","term":"action","order":"DESC","orderby":"meta_value_num","template":"archive","sidebar":"right","post_status":"publish","meta_query":{"relation":"OR","0":[]}};
	</script>
				...
				<div class="col-md-12">
					...
					<div class="c-breadcrumb">
						<ol class="breadcrumb">
							...
							if (isset($_GET['id_cate'])) {
								$id_cate=$_GET['id_cate'];
								$sql1="select * from categories where id='$id_cate' ";
							...
							<li>
								<a href="index.php?id_cate=<?php echo $kq1['id'] ?>">
									<?php echo $kq1['name']; ?>                                   </a>
								</li>
								...
								<div class="genres__collapse" style="display: none">
									<div class="row genres">
										<ul class="list-unstyled">
											<?php 
											include '../../db.php';
											$sqlm="select * from categories ";
											$kqm=$conn->query($sqlm);
											foreach ($kqm as $key => $row) {
												?>

												<li style="margin-left: 50px;">
													<a href="index.php?id_cate=<?php echo $row['id']?>"><?php echo $row['name']; ?></a>
												</li>	
									...
									<div class="entry-header">
										<div class="entry-header_wrap">
											<div class="entry-title">
												<h1 class="item-title h4"><?php echo $kq1['name']; ?></h1>
											</div>
										</div>
									</div>
													...
													<div class="page-content-listing item-default">
														...
														<div class="page-listing-item">
															<div class="row row-eq-height">
																<?php 
																include '../../db.php';
																$sql="select * from manga where id_cate='$id_cate'";
																$kq=$conn->query($sql);
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="nav-footer"><ul class="list-inline font-nav"><li id="menu-item-76" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-76"><a href="index.php" aria-current="page">TRANG CHỦ</a></li>
							<li id="menu-item-110" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-110"><a href="manga/index.php">XEM SAU</a></li>
