...
<!-- Mirrored from demo.mangabooth.com/manga-genre/action/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2019 19:02:37 GMT -->
...
<head>
	...
	<?php 
	include '../../db.php';
	if(isset($_GET['id_kind'])){
		$id_kind=$_GET['id_kind'];
		$sql_kind = "select * from kind where id = '$id_kind'";
		$kq_kind = $conn->query($sql_kind)->fetch();
	}
	?>
	

	<title><?php echo $kq_kind['name']; ?></title>
	...
	<link rel="alternate" type="application/rss+xml" title="Madara - WordPress Theme for Manga &raquo; Action Manga Genre Feed" href="feed/index.php" />
	...
	<style id='madara-css-inline-css' type='text/css'>
		...
		#adminmenu .wp-submenu li.current { display: none !important;}.show_tgmpa_version{ float: right; padding: 0em 1.5em 0.5em 0; }.tgmpa > h2{ font-size: 23px; font-weight: 400; line-height: 29px; margin: 0; padding: 9px 15px 4px 0;}.update-php{ width: 100%; height: 98%; min-height: 850px; padding-top: 1px; }@media only screen and (-webkit-min-device-pixel-ratio: 2),(min-resolution: 192dpi) {
			...
			<meta property="og:title" content="Madara - WordPress Theme for Manga | Manga Genres | Action"/>
			<meta name="twitter:card" content="summary" />
			<meta name="twitter:site" content="@Madara - WordPress Theme for Manga" />
			<meta name="twitter:title" content="Madara - WordPress Theme for Manga | Manga Genres | Action" />
			<meta name="twitter:image" content="http://demo.mangabooth.com/wp-content/themes/madara/images/logo.png" />
			<meta name="description" content="" /><meta name="generator" content="Powered by Madara - A powerful multi-purpose theme by Madara" />
		</head>

		<body class="archive tax-wp-manga-genre term-action term-2 wp-embed-responsive theme-madara wp-manga-page woocommerce-no-js page header-style-1 sticky-enabled sticky-style-2 is-sidebar text-ui-dark">
						...
						<div class="c-header__top">
							<ul class="search-main-menu">
								<li>
									<form id="blog-post-search" action="http://demo.mangabooth.com/" method="get">
										<input type="text" placeholder="Search..." name="s" rowe="">
										<input type="submit" rowe="Search">
							...
							<div class="main-navigation style-1 ">
																	...
																	<script>
																		jQuery(document).ready(function ($) {
																			if ($('.c-header__top .manga-search-form').length !== 0 && $('.c-header__top .manga-search-form.search-form').length !== 0) {
																				...
																				$('form#blog-post-search').append('<input type="hidden" name="post_type" rowe="wp-manga">');
								...
								<div class="mobile-menu menu-collapse off-canvas">
									...
									<div class="c-modal_item">
										...
										if(isset($_SESSION['user'])){
											...
											?>
											<a href="logout.php"><button style="border:0px;">Đăng xuất</button></a>
									...
									<nav class="off-menu">
										...
										<li id="nav-menu-item-110" class="main-menu-item menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children parent dropdown"><a href="../../manga/index.php" class="menu-link dropdown-toggle disabled main-menu-link" data-toggle="dropdown">MANGA </a>
											<ul class="dropdown-menu menu-depth-1">
												<li id="nav-menu-item-410" class="sub-menu-item menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/indexc7b7.php?genres_collapse=on" class="menu-link  sub-menu-link">ARCHIVES &#8211; SHOW GENRES </a></li>
												<li id="nav-menu-item-409" class="sub-menu-item menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/index.php" class="menu-link  sub-menu-link">ARCHIVES &#8211; HIDE GENRES </a></li>
												<li id="nav-menu-item-386" class="sub-menu-item menu-item-depth-1 menu-item menu-item-type-post_type menu-item-object-wp-manga"><a href="../../manga/hajime-boyfriend/index.php" class="menu-link  sub-menu-link">SINGLE MANGA </a></li>
												<li id="nav-menu-item-403" class="sub-menu-item menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children parent dropdown-submenu"><a href="#" class="menu-link  sub-menu-link">MANGA READING </a>
													<ul class="dropdown-menu menu-depth-2">
														<li id="nav-menu-item-453" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/massa-consectetur-mattis/index.php" class="menu-link  sub-menu-link">VIDEO CHAPTER </a></li>
														<li id="nav-menu-item-457" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/manga-text-chapter/index.php" class="menu-link  sub-menu-link">TEXT CHAPTER </a></li>
														<li id="nav-menu-item-404" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/ykataza-yin-wang-shynakimiz/index9056.php?display=wp-manga&amp;chapter=chapter-1&amp;style=paged" class="menu-link  sub-menu-link">LIGHT VERSION </a></li>
														<li id="nav-menu-item-405" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/dakimi-katawi-yakimimono-hajimazu-kyousou/index86e1.php?display=wp-manga&amp;chapter=chapter-1&amp;style=list&amp;body_schema=dark" class="menu-link  sub-menu-link">DARK VERSION </a></li>
														<li id="nav-menu-item-1845" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-post_type menu-item-object-wp-manga"><a href="../../manga/kyojin-shingeki-no/index.php" class="menu-link  sub-menu-link">18+ Warning Manga </a></li>
														<li id="nav-menu-item-346" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/miharu-rokujou/index109b.php?display=wp-manga&amp;chapter=chapter-1_1&amp;style=list" class="menu-link  sub-menu-link">LIST STYLE </a></li>
														<li id="nav-menu-item-345" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/miharu-rokujou/indexe32c.php?display=wp-manga&amp;chapter=chapter-1_1&amp;style=paged" class="menu-link  sub-menu-link">PAGED STYLE </a></li>
														<li id="nav-menu-item-413" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/kahana-no-shou/index63bb.php?host=local&amp;display=wp-manga&amp;chapter=chapter-1&amp;style=paged" class="menu-link  sub-menu-link">MULTI HOST </a></li>
														<li id="nav-menu-item-387" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/hajime-boyfriend/index9056.php?display=wp-manga&amp;chapter=chapter-1&amp;style=paged" class="menu-link  sub-menu-link">HOST LOCAL </a></li>
														<li id="nav-menu-item-388" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/nasama-okima/indexcf2d.php?display=wp-manga&amp;chapter=chapter-2&amp;style=paged" class="menu-link  sub-menu-link">HOST AMAZON </a></li>
														<li id="nav-menu-item-407" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/kagasarete-nairantou/index9056.php?display=wp-manga&amp;chapter=chapter-1&amp;style=paged" class="menu-link  sub-menu-link">HOST PICASA </a></li>
														<li id="nav-menu-item-408" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="../../manga/kahana-no-shou/index9056.php?display=wp-manga&amp;chapter=chapter-1&amp;style=paged" class="menu-link  sub-menu-link">HOST IMGUR </a></li>
											...
											<div class="sub-nav_content">
												<ul class="sub-nav_list list-inline second-menu">
													...
													foreach ($kqm as $key => $row) {
														...
														<li id="menu-item-54" class="menu-item menu-item-type-taxonomy menu-item-object-wp-manga-genre menu-item-54">
															<a href="index1.php?id_kind=<?php echo $row['id']?>"><?php echo $row['name']; ?></a></li>	
												...
												<div class="c-modal_item">
													...
													if(isset($_SESSION['user'])){
														...
														<a href="logout.php"><button style="border:0px;">Đăng xuất</button></a>
														<a href="doipass.php?id_doipass=<?php echo $_SESSION['id'] ?>">
															<button style="border:0px;">Đổi password</button>
														</a>
														<!-- <a href="doipass.php"><button>Đổi mật khẩu</button></a> -->
														<?php
													}
								...
								<div class="site-content">
									<script type="text/javascript">
										var manga_args = {"wp-manga-genre":"action","error":"","m":"","p":0,"post_parent":"","subpost":"","subpost_id":"","attachment":"","attachment_id":0,"name":"","pagename":"","page_id":0,"second":"","minute":"","hour":"","day":0,"monthnum":0,"year":0,"w":0,"category_name":"","tag":"","cat":"","tag_id":"","author":"","author_name":"","feed":"","tb":"","paged":1,"meta_key":"_latest_update","meta_rowe":"","preview":"","s":"","sentence":"","title":"","fields":"","menu_order":"","embed":"","category__in":[],"category__not_in":[],"category__and":[],"post__in":[],"post__not_in":[],"post_name__in":[],"tag__in":[],"tag__not_in":[],"tag__and":[],"tag_slug__in":[],"tag_slug__and":[],"post_parent__in":[],"post_parent__not_in":[],"author__in":[],"author__not_in":[],"ignore_sticky_posts":false,"suppress_filters":false,"cache_results":true,"update_post_term_cache":true,"lazy_load_term_meta":true,"update_post_meta_cache":true,"post_type":"wp-manga","posts_per_page":12,"nopaging":false,"comments_per_page":"50","no_found_rows":false,"taxonomy":"wp-manga-genre","term":"action","order":"DESC","orderby":"meta_rowe_num","template":"archive","sidebar":"right","post_status":"publish","meta_query":{"relation":"OR","0":[]}};
									</script>
									...
									<div class="c-breadcrumb-wrapper" style="background-image: url(http://demo.mangabooth.com/wp-content/themes/madara/images/bg-search.jpg">
													...
													<div class="c-breadcrumb">
														<ol class="breadcrumb">
															...
															<li>
																<?php 
																include '../../db.php';
																$sqlm="select * from kind where id='$id_kind'";
																$kqm=$conn->query($sqlm);
																foreach ($kqm as $key => $row) {
																	?>


																	<a href="index1.php?id_kind=<?php echo $row['id'] ?>">
																		<?php echo $kq_kind['name']; ?>                                       </a>
																		...
																		<ul class="list-unstyled">
																			...
																			foreach ($kqm as $key => $row) {
																				...
																				<li style="margin-left: 50px;">
																					<a href="index1.php?id_kind=<?php echo $row['id']?>"><?php echo $row['name']; ?></a>
																				</li>	
										...
										<div class="c-page-content style-1">
												...
												<div class="container">
													<div class="row ">
														...
														<div class="main-col col-md-8 col-sm-8">
															...
															<div class="ad c-ads custom-code body-top-ads"><img src="../../wp-content/uploads/2017/10/ads-1.jpg" alt="ads"></div>
																	...
																	<div class="entry-header">
																		<div class="entry-header_wrap">
																			<div class="entry-title">
																				<h1 class="item-title h4"><?php echo $kq_kind['name']; ?></h1>
																			</div>
																		</div>
																	</div>
                                            ...
                                            <!-- <i class="icon ion-ios-star"></i>
                                            	<?php echo $rowe['count_manga']; ?> -->                                        </div>

<!-- <div class="c-nav-tabs">
    <span> Sắp xếp </span>
    <ul class="c-tabs-content">
				<li class="">
            <a href="index7d49.php?m_orderby=latest">
				Mới nhất            </a>
        </li>
        <li class="">
            <a href="index3dbe.php?m_orderby=rating">
				Xếp hạng            </a>
        </li>
        <li class="">
            <a href="index38af.php?m_orderby=views">
				Lượt xem            </a>
        </li>
    </ul>
</div> -->
		...
		<div class="page-content-listing item-default">
			<div class="page-listing-item">
				<div class="row row-eq-height">
					<?php 
					include '../../db.php';
					$sql="select * from manga where id_kind='$id_kind'";
					$kq=$conn->query($sql);
						...
						<div class="col-12 col-md-6 " style="margin-top: 50px;">                                     	
							<div class="page-item-detail ">
								<div id="manga-item-311" class="item-thumb hover-details c-image-hover" data-post-id="311">
									<a href="../../manga/manga-text-chapter/index.php?id_manga=<?php echo $row['id'] ?>">
										<img  
										style="width: 100px;height: 130px;" src="../../images/<?php echo $row['images']; ?>" style="padding-top:150px; "/>                            </a>
									</div>
									<div class="item-summary">
										<div class="post-title font-title">
											<h3 class="h5">
												<a href="../../manga/manga-text-chapter/index.php?id_manga=<?php echo $row['id'] ?>"><?php echo $row['name'] ?></a>
											</h3>
										</div>
										<!-- <div class="meta-item rating">
											<div class="post-total-rating"><i class="ion-ios-star ratings_stars rating_current"></i><i class="ion-ios-star ratings_stars rating_current"></i><i class="ion-ios-star ratings_stars rating_current"></i><i class="ion-ios-star ratings_stars rating_current"></i><i class="ion-ios-star-outline ratings_stars"></i><span class="score font-meta total_votes">4</span></div>                   
										</div> -->
										<div class="list-chapter">
											<?php 
											$sql_chap="select * from chapters where id_manga='$id' limit 2" ;
											...
											foreach ($kq_chap as $key => $row1) {
												...
												<div class="chapter-item ">
													...
													<span class="chapter font-meta">
														<a href="../../manga/manga-text-chapter/chapter/index.php?id_chap=<?php echo $row1['id'] ?>" class="btn-link"><?php echo $row1['name']; ?></a>
													</span>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="nav-footer"><ul class="list-inline font-nav"><li id="menu-item-76" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-76"><a href="index.php" aria-current="page">TRANG CHỦ</a></li>
							<li id="menu-item-110" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-110"><a href="manga/index.php">MANGA</a></li>
							<li id="menu-item-75" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-75"><a href="about-us/index.php">VỀ CHÚNG TÔI</a>


<!-- <li id="menu-item-77" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-77"><a href="about-us/index.php">ABOUT US</a></li>
...
<div class="wp-manga-section">
	<input type="hidden" name="bookmarking" rowe="0"/>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<div class="modal-body">
						<div id="login" class="login">
							...
							<form name="loginform" id="loginform" method="post">
								<p>
									<label>Username or Email Address *                                    <br> <input type="text" name="log" class="input user_login" rowe="" size="20">
									</label>
								</p>
								<p>
									<label>Password *                                    <br> <input type="password" autocomplete="" name="pwd" class="input user_pass" rowe="" size="20">
									</label>
								</p>
								<p>
									...
									<noscript>
										<div style="width: 100%; height: 473px;">
											...
											margin: 10px 25px; padding: 0px; resize: none;" rowe="">
										</textarea>
									</div>
								</div>
							</div><br>
					...
					<p class="forgetmenot">
						<label>
							<input name="rememberme" type="checkbox" id="rememberme" rowe="forever">Remember Me                                 </label>
						</p>
						<p class="submit">
							<input type="submit" name="wp-submit" class="button button-primary button-large wp-submit" rowe="Log In">                                <input type="hidden" name="redirect_to" rowe="http://demo.mangabooth.com/wp-admin/">
							<input type="hidden" name="testcookie" rowe="1">
						</p>
					</form>
					<p class="nav">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="modal-body">
					<div id="sign-up" class="login">
						...
						<form name="registerform" id="registerform" novalidate="novalidate">
							<p>
								<label>Username *                                    <br>
									<input type="text" name="user_sign-up" class="input user_login" rowe="" size="20">
								</label>
							</p>
							<p>
								<label>Email Address *                                    <br>
									<input type="email" name="email_sign-up" class="input user_email" rowe="" size="20">
								</label>
							</p>
							<p>
								<label>Password *<br>
									<input type="password" name="pass_sign-up" autocomplete="" class="input user_pass" rowe="" size="25">
								</label>
							</p>
							<p>
								<div class="g-recaptcha" id="g-recaptcha" data-sitekey="6Ldsz6QUAAAAADxlB_1jgAkKgtRjrq8kwzgLSXen" data-callback="submitEnable" data-expired-callback="submitDisable"></div>
				...
				<input type="hidden" name="redirect_to" rowe="">
				<p class="submit">
					<input type="submit" name="wp-submit" class="button button-primary button-large wp-submit" rowe="Register">
				</p>
			</form>
			<p class="nav">
						...
						<form name="resetform" id="resetform" method="post">
							<p>
								<label>Username or Email Address                                    <br>
									<input type="text" name="user_reset" id="user_reset" class="input" rowe="" size="20">
								</label>
							</p>
							<p class="submit">
								<input type="submit" name="wp-submit" class="button button-primary button-large wp-submit" rowe="Get New Password">
								<input type="hidden" name="testcookie" rowe="1">
							</p>
						</form>
						<p>
...
<script type='text/javascript'>
	/* <![CDATA[ */
	var madara = {"ajaxurl":"http:\/\/demo.mangabooth.com\/wp-admin\/admin-ajax.php","query_vars":{"wp-manga-genre":"action","error":"","m":"","p":0,"post_parent":"","subpost":"","subpost_id":"","attachment":"","attachment_id":0,"name":"","pagename":"","page_id":0,"second":"","minute":"","hour":"","day":0,"monthnum":0,"year":0,"w":0,"category_name":"","tag":"","cat":"","tag_id":"","author":"","author_name":"","feed":"","tb":"","paged":0,"meta_key":"","meta_rowe":"","preview":"","s":"","sentence":"","title":"","fields":"","menu_order":"","embed":"","category__in":[],"category__not_in":[],"category__and":[],"post__in":[],"post__not_in":[],"post_name__in":[],"tag__in":[],"tag__not_in":[],"tag__and":[],"tag_slug__in":[],"tag_slug__and":[],"post_parent__in":[],"post_parent__not_in":[],"author__in":[],"author__not_in":[],"ignore_sticky_posts":false,"suppress_filters":false,"cache_results":true,"update_post_term_cache":true,"lazy_load_term_meta":true,"update_post_meta_cache":true,"post_type":"","posts_per_page":12,"nopaging":false,"comments_per_page":"50","no_found_rows":false,"taxonomy":"wp-manga-genre","term":"action","order":"DESC"},"current_url":"http:\/\/demo.mangabooth.com\/manga-genre\/action"};
	/* ]]> */
</script>
...
<!-- Mirrored from demo.mangabooth.com/manga-genre/action/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2019 19:02:39 GMT -->
</html>