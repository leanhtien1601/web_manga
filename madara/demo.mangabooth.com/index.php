...
<!-- Mirrored from demo.mangabooth.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2019 18:53:29 GMT -->
...
<head>
	...
	<style id='madara-css-inline-css' type='text/css'>
		...
		#adminmenu .wp-submenu li.current { display: none !important;}.show_tgmpa_version{ float: right; padding: 0em 1.5em 0.5em 0; }.tgmpa > h2{ font-size: 23px; font-weight: 400; line-height: 29px; margin: 0; padding: 9px 15px 4px 0;}.update-php{ width: 100%; height: 98%; min-height: 850px; padding-top: 1px; }@media only screen and (-webkit-min-device-pixel-ratio: 2),(min-resolution: 192dpi) {
			...
			<link rel="alternate" type="application/json+oembed" href="wp-json/oembed/1.0/embed88d9.json?url=http%3A%2F%2Fdemo.mangabooth.com%2F" />
			<link rel="alternate" type="text/xml+oembed" href="wp-json/oembed/1.0/embed4238?url=http%3A%2F%2Fdemo.mangabooth.com%2F&amp;format=xml" />
			...
			<meta property="og:title" content="Madara - WordPress Theme for Manga"/>
			...
			<meta name="twitter:title" content="Madara - WordPress Theme for Manga" />
		...
		<body class="home page-template page-template-page-templates page-template-front-page page-template-page-templatesfront-page-php page page-id-12 wp-embed-responsive theme-madara woocommerce-no-js header-style-1 sticky-enabled sticky-style-2 is-sidebar text-ui-dark">


			<div id="pageloader" class="spinners">
				<div class="spinner"><div class="c-pre-loading-logo"><a class="logo" href="index.php" title="Madara - WordPress Theme for Manga"><img class="for-original" src="wp-content/themes/madara/images/logo.png" alt="Madara - WordPress Theme for Manga" /></a></div><div class="loader-inner ball-grid-pulse">
					<div></div>
					<div></div>
					<div></div>
					<div></div>
			...
			<div class="body-wrap">
				<header class="site-header">
					<div class="c-header__top">
						...
						<div class="mobile-menu menu-collapse off-canvas">
							...
							<div class="c-modal_item">
								...
								<span class="c-modal_sign-up">
									<a href="dangki.php "  class="btn-active-modal">Đăng Xuất</a>
								</span>
										...
										<div class="c-modal_item">
											<div 	><?php 
															...
															if(isset($_SESSION['user'])){
																...
																?>
																<a href="logout.php"><button style="border:0px;height: 30px;">Đăng xuất</button></a>
																
																<a href="doipass.php?id_doipass=<?php echo $_SESSION['id'] ?>">
																	<button style="border:0px;height: 30px;">Đổi mật khẩu</button>
																</a>
						...
						<div class="c-sidebar c-top-sidebar" style=" padding:50px 5px ; " >
							<div class="container c-container">
								<div class="row c-row">
									<div id="manga-slider-4" class="widget col-xs-12 col-md-12   default  no-icon heading-style-1 manga-widget widget-manga-slider"><div class="widget__inner manga-widget widget-manga-slider__inner c-widget-wrap"><div class="widget-content">
										<div class="manga-slider style-2" data-autoplay="0" data-style="style-2" data-count="2">
															...
															<div class="slider__thumb">
																<div class="slider__thumb_item">
																	<a href="<?php echo $value['link'] ?>">
																		<img width="642" height="320" class="img-responsive lazyload effect-fade" src="images/<?php echo $value['image'] ?>" style="padding-top:49.844236760125%; " />                    <div class="slider-overlay"></div>
																	</a>
																</div>
															</div>
							...
							<div class="c-sidebar c-top-second-sidebar" style="background-image:url(wp-content/uploads/2017/10/bg-search.jpg);  padding:50px 10px ; " >
								<div class="container c-container">
									<div class="row c-row">
										<div id="manga-popular-slider-5" class="widget col-12 col-md-12   default    heading-style-2 manga-widget widget-manga-popular-slider"><div class="widget__inner manga-widget widget-manga-popular-slider__inner c-widget-wrap">
											<div class="popular-slider style-1" data-autoplay="0" data-style="style-1" data-count="4">
												<div class="c-blog__heading style-2 font-heading">
													<h4><i class="icon ion-md-flash"></i>Truyện Mới Cập Nhật</h4></div><div class="widget-content">                <div class="slider__container" role="toolbar">

														<?php 
														include 'db.php';
														$sqla="select * from manga";
														$kqa=$conn->query($sqla);
														foreach ($kqa as $key => $va) {
															$id=$va['id'];
															?>
															<div class="slider__item">
																<div class="item__wrap " style="width: 250px;height: 130px">

																	<div class="slider__thumb">
																		<div class="slider__thumb_item c-image-hover"  >
																			<a href="manga/manga-text-chapter/index.php?id_manga=<?php echo $va['id'] ?>">
																				<img style="height: 130px"   class="img-responsive lazyload effect-fade" src="images/<?php echo $va['images'] ?>" />                        <div class="slider-overlay"></div>
																			</a>
																		</div>
																	</div>
																	...
																	<div class="slider__content">
																		<div class="slider__content_item">
																			<div class="post-title font-title">
																				<h4>
																					<a href="manga/manga-text-chapter/index.php?id_manga=<?php echo $va['id'] ?>"><?php echo $va['name']; ?></a>
																				</h4>
																			</div>
																			<div class="post-on font-meta">
																				<span>
																					<?php echo $va['date']; ?>                       </span>
																				</div>

																				
																				<?php 
																				$sql_chap="select * from chapters where id_manga ='$id' limit 1" ;
																			...
																			<div id="loop-content" class="page-content-listing item-default">
																				...
																				<div class="page-listing-item">
																					...
																					<div class="row row-eq-height">
																						...
																						<?php 
																						include 'db.php';
																						$sql2="select * from manga order by date desc"   ;
																						$kq2=$conn->query($sql2);
																						foreach ($kq2 as $key => $valu) {
																							$id=$valu['id'];
																							?>
																							...
																							<div class="col-12 col-md-6 ">                                     	
																								<div class="page-item-detail ">
																									<div id="manga-item-311" class="item-thumb hover-details c-image-hover" data-post-id="311">
																										<a href="manga/manga-text-chapter/index.php?id_manga=<?php echo $valu['id'] ?>" title="">
																											<img  
																											style="width: 100px;height: 130px;"  class="img-responsive lazyload effect-fade" src="images/<?php echo $valu['images']; ?>" style="padding-top:150px; " />                            </a>
																										</div>
																										<div class="item-summary">
																											<div class="post-title font-title">
																												<h3 class="h5">
																													<a href="manga/manga-text-chapter/index.php?id_manga=<?php echo $valu['id'] ?>"><?php echo $valu['name'] ?></a>
																												</h3>
																											</div>
                   <!--  <div class="meta-item rating">
                   	...
                   	<div class="list-chapter"> 
                   		<div class="chapter-item "> 
                   			...
                   			include 'db.php';
                   			$sql1="select * from chapters  where id_manga='$id'  limit 2 ";
                   			$kq1=$conn->query($sql1);
                   			foreach ($kq1 as $key => $vale) {
                   				
                   				?>
                   				<span class="chapter font-meta">
                   					<a href="manga/manga-text-chapter/chapter/index.php?id_chap=<?php echo $vale['id'] ?>" class="btn-link"><?php echo $vale['name'] ?></a>
                   				</span>
                   				<?php
                   			...
                   			<span class="post-on font-meta" style="margin-top: 20px;">
                   				Ngày đăng truyện : <?php echo $valu['date']; ?>                               </span>
                   				<span class="post-on font-meta" style="margin-top: 20px;">Tác giả truyện :  
                   					...
                   					foreach ($kq12 as $key => $au) {
                   						...
                   						<?php if($au['id'] == $valu['id_author']){ echo $au['name'];} ?>
...
<script type="text/javascript">
	var manga_args = {"orderby":"meta_value_num","paged":1,"posts_per_page":20,"tax_query":{"relation":"OR"},"meta_query":{"relation":"OR","0":{"relation":"AND"}},"post_type":"wp-manga","post_status":"publish","meta_key":"_latest_update","order":"DESC","error":"","m":"","p":0,"post_parent":"","subpost":"","subpost_id":"","attachment":"","attachment_id":0,"name":"","pagename":"","page_id":0,"second":"","minute":"","hour":"","day":0,"monthnum":0,"year":0,"w":0,"category_name":"","tag":"","cat":"","tag_id":"","author":"","author_name":"","feed":"","tb":"","meta_value":"","preview":"","s":"","sentence":"","title":"","fields":"","menu_order":"","embed":"","category__in":[],"category__not_in":[],"category__and":[],"post__in":[],"post__not_in":[],"post_name__in":[],"tag__in":[],"tag__not_in":[],"tag__and":[],"tag_slug__in":[],"tag_slug__and":[],"post_parent__in":[],"post_parent__not_in":[],"author__in":[],"author__not_in":[],"ignore_sticky_posts":false,"suppress_filters":false,"cache_results":true,"update_post_term_cache":true,"lazy_load_term_meta":true,"update_post_meta_cache":true,"nopaging":false,"comments_per_page":"50","no_found_rows":false};
</script>

<script type="text/javascript">
	var __madara_query_vars = {"orderby":"meta_value_num","paged":1,"posts_per_page":"20","tax_query":{"relation":"OR"},"meta_query":{"relation":"OR","0":{"relation":"AND"}},"post_type":"wp-manga","post_status":"publish","meta_key":"_latest_update","order":"desc","sidebar":"right","manga_archives_item_layout":"default"};
</script>
...
<div class="sidebar-col col-md-4 col-sm-4">
	<div id="main-sidebar" class="main-sidebar" role="complementary">
		<div class="row"><div id="cool_tag_cloud-2" class="widget col-xs-12 col-md-12   default  no-icon heading-style-1 widget_cool_tag_cloud"></div></div><div class="widget_text row"><div id="custom_html-12" class="widget_text widget col-12 col-md-12   default no-icon  widget_custom_html"><div class="widget_text widget__inner widget_custom_html__inner c-widget-wrap"><div class="widget_text widget-content"><!-- <div class="textwidget custom-html-widget"><img src="wp-content/uploads/2017/10/ads-square.jpg" alt="ads"></div> --></div></div></div></div><div class="row"><div id="manga-recent-4" class="widget col-xs-12 col-md-12   bordered  no-icon heading-style-1 c-popular manga-widget widget-manga-recent"><div class="widget__inner c-popular manga-widget widget-manga-recent__inner c-widget-wrap">
			<div class="c-widget-content style-1 with-button">
				<div class="widget-heading font-nav"><h5 class="heading">TOP LƯỢT XEM </h5></div><div class="widget-content">                  
					<?php 
					$sql="select * from manga order by view DESC limit 5";
					$kq=$conn->query($sql);
					foreach ($kq as $key => $row) {
						...
						<div class="popular-item-wrap">
							...
							<div class="popular-img widget-thumbnail c-image-hover">
								<a title="Manga Text Chapter" href="manga/manga-text-chapter/index.php?id_manga=<?php echo $row['id'] ?>">
									<img style="height: 70px" class="img-responsive lazyload effect-fade" src="images/<?php echo $row['images'] ?>" />        </a>
								</div>
				        ...
				        <a class="widget-view-more" href="manga/indexc32a.php?m_orderby=trending">Here for more Popular Manga</a>
				    </span> -->
	...
	<div class="c-sidebar c-bottom-sidebar" style="background-color:#f3f3f3;  padding:50px 7px ; ">
		<div class="container c-container">
			<div class="row c-row">
				<div id="manga-genres-id-8" class="widget col-xs-12 col-md-12   default  no-icon heading-style-1 manga-genres-class-name"><div class="widget__inner manga-genres-class-name__inner c-widget-wrap">        <div class="genres_wrap">
					<div class="row">
						<div class="col-md-12">
							<div class="widget-heading font-nav"><h5 class="heading">THỂ LOẠI</h5></div><div class="widget-content">                        <div class="genres__collapse" style="display:block;">
								<div class="row genres">
									<ul class="list-unstyled">
										...
										$sqlm="select * from kind ";
										$kqm=$conn->query($sqlm);
										foreach ($kqm as $key => $row1){
											?>
											<li class="col-xs-6 col-sm-4 col-md-3 col-lg-2 col-6">
												<a href="manga-genre/kind/index1.php?id_kind=<?php echo $row1['id'] ?>">
...
<script type='text/javascript'>
	/* <![CDATA[ */
	var embedVars = {"disqusConfig":{"integration":"wordpress 3.0.12"},"disqusIdentifier":"12 http:\/\/demo.mangabooth.com\/?page_id=12","disqusShortname":"madara-1","disqusTitle":"HOME","disqusUrl":"http:\/\/demo.mangabooth.com\/","postId":"12"};
	/* ]]> */
</script>
...
<!-- Mirrored from demo.mangabooth.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2019 18:56:21 GMT -->
</html>