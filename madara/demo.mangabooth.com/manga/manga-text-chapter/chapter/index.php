	...
	if(isset($_GET['id_chap'])){
		...
		$sql_chap = "select * from 	chapters where id = '$id_chap'";
		$kq_chap = $conn->query($sql_chap)->fetch();
		$value_mg=$kq_chap['id_manga'];
	}
	?>
	<?php 
	include '../../db.php';
	$sqlv="update manga set view = view + 1 where id ='$value_mg'";
	$kqv=$conn->query($sqlv);
	?>
	<!DOCTYPE html>
	<html lang="en-US">

	<!-- Mirrored from demo.mangabooth.com/manga/manga-text-chapter/chapter-1/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2019 19:05:22 GMT -->
	...
	<head>
		...
		<title>Chương <?php echo $kq_chap['order'] ?></title>
		...
		"description": "Manga Text Chapter. Chapter 1 - There’s something about being the last child. A land where the strong makes the rules and weak has to obey. A land filled with alluring treasures and beauty yet also filled with unforeseen danger. Xikajio Yan, w"
	}
</script>
...
<meta property="og:title" content="Manga Text Chapter - Chapter 1 - There’s something about being the last child - Madara - WordPress Theme for Manga"/>
<meta property="og:url" content="http://demo.mangabooth.com/manga/manga-text-chapter/chapter-1/"/>
<meta property="og:description" content="Manga Text Chapter. Chapter 1 - There’s something about being the last child. A land where the strong makes the rules and weak has to obey. A land filled with alluring treasures and beauty yet also filled with unforeseen danger. Xikajio Yan, w"/>
<meta name="twitter:card" content="summary" />
<meta name="twitter:site" content="@Madara - WordPress Theme for Manga" />
<meta name="twitter:title" content="Manga Text Chapter - Chapter 1 - There’s something about being the last child - Madara - WordPress Theme for Manga" />
<meta name="twitter:description" content="Manga Text Chapter. Chapter 1 - There’s something about being the last child. A land where the strong makes the rules and weak has to obey. A land filled with alluring treasures and beauty yet also filled with unforeseen danger. Xikajio Yan, w" />
<meta name="twitter:url" content="http://demo.mangabooth.com/manga/manga-text-chapter/chapter-1/" />
<meta name="twitter:image" content="http://demo.mangabooth.com/wp-content/uploads/2017/10/wallhaven-550105-1200x630.jpg" />
<meta name="description" content="Manga Text Chapter. Chapter 1 - There’s something about being the last child. A land where the strong makes the rules and weak has to obey. A land filled with alluring treasures and beauty yet also filled with unforeseen danger. Xikajio Yan, w" /><meta name="generator" content="Powered by Madara - A powerful multi-purpose theme by Madara" />
</head>

<body class="wp-manga-template-default single single-wp-manga postid-454 wp-embed-responsive theme-madara wp-manga-page reading-manga click-to-scroll woocommerce-no-js page header-style-1 sticky-enabled sticky-style-2 is-sidebar text-ui-dark manga-reading-paged-style">
					...
					<div class="main-navigation style-1 ">
						...
						<div class="mobile-menu menu-collapse off-canvas">
							...
							<nav class="off-menu">
								...
								<li id="nav-menu-item-110" class="main-menu-item menu-item-depth-0 menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children parent dropdown"><a href="../../index.php" class="menu-link dropdown-toggle disabled main-menu-link" data-toggle="dropdown">MANGA </a>
									<ul class="dropdown-menu menu-depth-1">
										...
										<li id="nav-menu-item-403" class="sub-menu-item menu-item-depth-1 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children parent dropdown-submenu"><a href="#" class="menu-link  sub-menu-link">MANGA READING </a>
											<ul class="dropdown-menu menu-depth-2">
												...
												<li id="nav-menu-item-457" class="sub-menu-item menu-item-depth-2 menu-item menu-item-type-custom menu-item-object-custom"><a href="../index.php" class="menu-link  sub-menu-link">TEXT CHAPTER </a></li>
...
<a href="../../../login.php"  class="btn-active-modal">Đăng Nhập</a>
												...
												<div class="c-selectpicker selectpicker_chapter">
													<label>
														<select class="selectpicker single-chapter-select">
															...
															$sql="select * from chapters where id_manga='$value_mg'";
															$kq=$conn->query($sql);
															foreach ($kq as $key => $value) {
																?>
																<option data-redirect="index.php?id_chap=<?php echo $value['id'] ?>" class="short " data-limit="40" value="<?php echo $value['id'] ?>" <?php if($value['id']==$kq_chap['id']){
																	echo "selected";
						...
						<div class="site-content">
							...
							<div class="c-page-content style-1 reading-content-wrap chapter-type-text" data-site-url="../../../index.php">
								<div class="content-area">
									<div class="container">
										<div class="row">
											<?php 
											$sql_1="select * from manga";
											$kq_1=$conn->query($sql_1)->fetch();
											if($kq_1['id']==$kq_chap['id_manga']){
												?>


												<div class="main-col col-md-12 col-sm-12 sidebar-hidden">
													<h1 id="chapter-heading"><?php echo $kq_1['name']; ?> Chương <?php echo $kq_chap['order']; ?></h1>
																		...
																		<div class="c-breadcrumb-wrapper" >
																			...
																			<div class="c-breadcrumb">
																				<ol class="breadcrumb">
																					...
																					<li>
																						<a href="../index.php?id_manga=<?php echo $kq_1['id'] ?>">
																							<?php echo $kq_1['name']; ?>
																					...
																					<li class="active">
																						<a href="index.php?id_chap=<?php echo $kq_chap['id'] ?>">
																							Chương <?php echo $kq_chap['order']; ?>
																						</a>
																					</li>
																			...
																			<label>
																				<select class="selectpicker single-chapter-select">
																					...
																					?>
																						...
																						<!-- <option class="short " data-limit="40" value="chapter-2" data-redirect="http://demo.mangabooth.com/manga/manga-text-chapter/chapter-2/" >Chương 2</option>

																							<option class="short " data-limit="40" value="chapter-3" data-redirect="http://demo.mangabooth.com/manga/manga-text-chapter/chapter-3/" >Chương 3</option> -->
																		...
																		<div class="entry-content_wrap">
																			...
																			<div class="read-container" >
																				...
																				<div class="reading-content" >
																					...
																					<div><?php echo $kq_chap['content'] ?></div>
																				...
																				<div class="c-breadcrumb-wrapper" >
																					...
																					<div class="c-breadcrumb">
																						<ol class="breadcrumb">
																							...
																							<?php 
																							$sql_2="select * from manga where id='$value_mg'";
																							$kq_2=$conn->query($sql_2);
																							foreach ($kq_2 as $key => $row2) {
																								?>
																								<li>
																									<a href="../index.php?id_manga=<?php echo $row2['id'] ?>">
																		...
																		<div class="row c-row related-manga">
																				...
																				if($value_kind == $kq_kind['id_kind']){
																					...
																					<div class="col-12 col-sm-6 col-md-3">
																						<div class="related-reading-img widget-thumbnail c-image-hover">
																							<a href="../index.php?id_manga=<?php echo$kq_kind['id'] ?>">
																			...
																			?>
																				<!-- <div class="col-12 col-sm-6 col-md-3">
																					<div class="related-reading-wrap">
																						<div class="related-reading-img widget-thumbnail c-image-hover">
																							<a title="Miharu Rokujou" href="../../miharu-rokujou/index.php">
																								<img width="75" height="106"  data-src="http://demo.mangabooth.com/wp-content/uploads/2017/10/wallhaven-529968-75x106.jpg" class="img-responsive lazyload effect-fade" src="../../../wp-content/themes/madara/images/dflazy.jpg" style="padding-top:106px; " alt="wallhaven-529968"/>                                    </a>
																							</div>
																							<div class="related-reading-content">
																								<h5 class="widget-title">
																									<a href="../../miharu-rokujou/index.php" title="Miharu Rokujou">
																									Miharu Rokujou                                        </a>
																								</h5>
																							</div>
																							<div class="post-on font-meta">
																					...
																					<div class="col-12 col-sm-6 col-md-3">
																						<div class="related-reading-wrap">
																							<div class="related-reading-img widget-thumbnail c-image-hover">
																								<a title="Lahasha Ya Shyng Bukitaza" href="../../lahasha-ya-shyng-bukitaza/index.php">
																									<img width="75" height="106"  data-src="http://demo.mangabooth.com/wp-content/uploads/2017/10/wallhaven-539934-75x106.jpg" class="img-responsive lazyload effect-fade" src="../../../wp-content/themes/madara/images/dflazy.jpg" style="padding-top:106px; " alt="wallhaven-539934"/>                                    </a>
																								</div>
																								<div class="related-reading-content">
																									<h5 class="widget-title">
																										<a href="../../lahasha-ya-shyng-bukitaza/index.php" title="Lahasha Ya Shyng Bukitaza">
																										Lahasha Ya Shyng Bukitaza                                        </a>
																									</h5>
																								</div>
																								<div class="post-on font-meta">
																									<span>
																						...
																						<div class="col-12 col-sm-6 col-md-3">
																							<div class="related-reading-wrap">
																								<div class="related-reading-img widget-thumbnail c-image-hover">
																									<a title="Hajime boyfriend" href="../../hajime-boyfriend/index.php">
																										<img width="75" height="106"  data-src="http://demo.mangabooth.com/wp-content/uploads/2017/10/wallhaven-524774-75x106.jpg" class="img-responsive lazyload effect-fade" src="../../../wp-content/themes/madara/images/dflazy.jpg" style="padding-top:106px; " alt="wallhaven-524774"/>                                    </a>
																									</div>
																									<div class="related-reading-content">
																										<h5 class="widget-title">
																											<a href="../../hajime-boyfriend/index.php" title="Hajime boyfriend">
																											Hajime boyfriend                                        </a>
																										</h5>
																									</div>
																									<div class="post-on font-meta">
	                    			...
	                    			<div class="modal-content">
	                    				<div class="modal-header">
	                    					...
	                    					<p class="forgetmenot">
	                    						...
	                    						<p class="submit">
	                    							<input type="submit" name="wp-submit" class="button button-primary button-large wp-submit" value="Log In">                                <input type="hidden" name="redirect_to">
	            ...
	            <script type='text/javascript'>
	            	/* <![CDATA[ */
	            	var embedVars = {"disqusConfig":{"integration":"wordpress 3.0.12"},"disqusIdentifier":"454 http:\/\/demo.mangabooth.com\/?post_type=wp-manga&p=454&chapter=chapter-1","disqusShortname":"madara-1","disqusTitle":"Manga Text Chapter","disqusUrl":"http:\/\/demo.mangabooth.com\/manga\/manga-text-chapter\/chapter-1\/","postId":"454"};
	            	/* ]]> */
	            </script>
	            ...
	            <script type='text/javascript'>
	            	/* <![CDATA[ */
	            	var wc_add_to_cart_params = {"ajax_url":"\/\/","wc_ajax_url":"\/?wc-ajax=%%endpoint%%","i18n_view_cart":"View cart","cart_url":"http:\/\/demo.mangabooth.com\/cart\/","is_cart":"","cart_redirect_after_add":"no"};
	            	/* ]]> */
	            </script>
	            ...
	            <script type='text/javascript'>
	            	/* <![CDATA[ */
	            	var wc_cart_fragments_params = {"ajax_url":"\/\/","wc_ajax_url":"\/?wc-ajax=%%endpoint%%","cart_hash_key":"wc_cart_hash_df05cd485b217b61c8c2d2efbd7ebb6b","fragment_name":"wc_fragments_df05cd485b217b61c8c2d2efbd7ebb6b","request_timeout":"5000"};
	            	/* ]]> */
	            </script>
	            ...
	            <script type='text/javascript'>
	            	/* <![CDATA[ */
	            	var madara = {"ajaxurl":"http:\/\/demo.mangabooth.com\/\/","query_vars":{"manga-core":"manga-text-chapter","post_type":"wp-manga","name":"manga-text-chapter","chapter":"chapter-1","error":"","m":"","p":0,"post_parent":"","subpost":"","subpost_id":"","attachment":"","attachment_id":0,"pagename":"","page_id":0,"second":"","minute":"","hour":"","day":0,"monthnum":0,"year":0,"w":0,"category_name":"","tag":"","cat":"","tag_id":"","author":"","author_name":"","feed":"","tb":"","paged":0,"meta_key":"","meta_value":"","preview":"","s":"","sentence":"","title":"","fields":"","menu_order":"","embed":"","category__in":[],"category__not_in":[],"category__and":[],"post__in":[],"post__not_in":[],"post_name__in":[],"tag__in":[],"tag__not_in":[],"tag__and":[],"tag_slug__in":[],"tag_slug__and":[],"post_parent__in":[],"post_parent__not_in":[],"author__in":[],"author__not_in":[],"ignore_sticky_posts":false,"suppress_filters":false,"cache_results":true,"update_post_term_cache":true,"lazy_load_term_meta":true,"update_post_meta_cache":true,"posts_per_page":12,"nopaging":false,"comments_per_page":"50","no_found_rows":false,"order":"DESC"},"current_url":"http:\/\/demo.mangabooth.com\/manga\/manga-text-chapter\/chapter-1","cursorPrev":"http:\/\/demo.mangabooth.com\/wp-content\/themes\/madara\/images\/cursorLeft.png","cursorNext":"http:\/\/demo.mangabooth.com\/wp-content\/themes\/madara\/images\/cursorRight.png"};
	            	/* ]]> */
	            </script>
	            ...
	            <script type='text/javascript'>
	            	/* <![CDATA[ */
	            	var wpMangaLogin = {"admin_ajax":"http:\/\/demo.mangabooth.com\/\/","home_url":"http:\/\/demo.mangabooth.com"};
	            	/* ]]> */
	            </script>
	            ...
	            <script type='text/javascript'>
	            	/* <![CDATA[ */
	            	var manga = {"ajax_url":"http:\/\/demo.mangabooth.com\/\/","home_url":"http:\/\/demo.mangabooth.com","manga_paged_var":"manga-paged","manga_id":"454","chapter_slug":"chapter-1"};
	            	/* ]]> */
	            </script>
	        ...
	        <!-- Mirrored from demo.mangabooth.com/manga/manga-text-chapter/chapter-1/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2019 19:05:29 GMT -->
	        </html>