...
<!-- Mirrored from demo.mangabooth.com/?s=&post_type=wp-manga by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2019 19:00:40 GMT -->
...
<head>
	...
	<link rel="alternate" type="application/rss+xml" title="Madara - WordPress Theme for Manga &raquo; Manga Feed" href="manga/feed/index.php" />
	...
	<style id='madara-css-inline-css' type='text/css'>
		...
		#adminmenu .wp-submenu li.current { display: none !important;}.show_tgmpa_version{ float: right; padding: 0em 1.5em 0.5em 0; }.tgmpa > h2{ font-size: 23px; font-weight: 400; line-height: 29px; margin: 0; padding: 9px 15px 4px 0;}.update-php{ width: 100%; height: 98%; min-height: 850px; padding-top: 1px; }@media only screen and (-webkit-min-device-pixel-ratio: 2),(min-resolution: 192dpi) {
			...
			<meta property="og:title" content="Madara - WordPress Theme for Manga | Search Results  |  "/>
			...
			<meta name="twitter:title" content="Madara - WordPress Theme for Manga | Search Results  |  " />
		...
		<body class="archive search search-results post-type-archive post-type-archive-wp-manga wp-embed-responsive theme-madara wp-manga-page woocommerce-no-js page header-style-1 sticky-enabled sticky-style-2 is-sidebar text-ui-dark">
				...
				<div class="body-wrap">
					<header class="site-header">
														...
														<li id="menu-item-110" class="menu-item menu-item-type-taxonomy menu-item-object-wp-manga-genre menu-item-51"><a href="manga/index.php">XEM SAU</a>
															...
															foreach ($kq as $key => $value) {
																...
																<li id="menu-item-75" class="menu-item menu-item-type-taxonomy menu-item-object-wp-manga-genre menu-item-51">
																	<a href=" manga-genre/kind/index.php?id_kind=<?php echo $value['id']?>">
																		<?php echo $value['name']; ?>
																	</a>
																</li>
																<?php 
										...
										<ul class="sub-nav_list list-inline second-menu">
											...
											foreach ($kqm as $key => $row) {
												...
												<li id="menu-item-54" class="menu-item menu-item-type-taxonomy menu-item-object-wp-manga-genre menu-item-54">
													<a href="manga-genre/kind/index.php?id_cate=<?php echo $row['id']?>"><?php echo $row['name']; ?></a></li>	
						...
						<div class="site-content">
							<!--<header class="site-header">-->
								<div class="c-search-header__wrapper" style="background-image: url(wp-content/themes/madara/images/bg-search.jpg);">
									<div class="container">
										...
										<div class="search-content">
											...
											<form  method="get" class="search-form" >
												...
												<input type="submit" class="search-submit" value="search" name="ok">
											</form>
										...
										<script type="text/javascript">
											var manga_args = {"s":"","orderby":"","paged":1,"template":"search"};
										</script>
																...
																<div class="search-wrap">
																	<div class="tab-wrap">
																		<div class="c-blog__heading style-2 font-heading">
																			<h1 class="h4">
																				<i class="icon ion-ios-star"></i> Kết quả tìm kiếm                                                </h1>
																			</div>
																		</div>
																		<!-- Tab panes -->
        ...
        // Nếu người dùng submit form thì thực hiện
																								...
																								<div class="row c-tabs-item__content">
																									<div class="col-4 col-sm-2 col-md-2">
																										<div class="tab-thumb c-image-hover">
																											<a href="manga/manga-text-chapter/index.php?id_manga=<?php echo $value['id']?>" title="Manga Text Chapter">
																												<img width="193px" height="350px"   class="img-responsive lazyload effect-fade" src="images/<?php echo $value['images'] ?>" style="padding-top:278px; " alt="wallhaven-550105"/>                    </a>
																											</div>
																										</div>
																										<div class="col-8 col-sm-10 col-md-10">
																											<div class="tab-summary">
																												<div class="post-title">
																													<h3 class="h4"><a href="manga/manga-text-chapter/index.php?id_manga=<?php echo $value['id']?>"><?php echo $value['name'] ?></a></h3>
																												</div>
																												<div class="post-content">
																													<div class="post-content_item mg_author">
																														...
																														<div class="summary-content">
																															<a href=""> 
																																<?php 
																																$sqltg="select * from authors";
																																$kqtg=$conn->query($sqltg);
																																foreach ($kqtg as $key => $tg) {
																																	if($tg['id']==$value['id_author']){
																																		echo $tg['name'];
																																	}
																																}
																																 ?>
																														...
																														<div class="post-content_item mg_genres">
																															...
																															<div class="summary-content">
																																<a href="manga-genre/action/index.php">
																																	<?php
																																	$sql1="select * from kind ";
																																	$kq2=$conn->query($sql1);
																																	foreach ($kq2 as $key => $row) {
																																		?>
																																		<?php if($row['id'] == $value['id_kind']){ echo $row['name'];} ?>
																																		<?php
																																	}
																																	?>
																														...
																														<div class="post-content_item mg_release">
																															...
																															<div class="summary-content release-year">
																																<a href="manga-release/2015/index.php"><?php echo $value['date'] ?>  </a>                            </div>
																															</div>
																														</div>
																													</div>
			...
			<script type="text/javascript">
				var __madara_query_vars = {"s":"","orderby":"","paged":1,"template":"search","post_type":"wp-manga","post_status":"publish","meta_query":{"relation":"OR","0":[]},"manga_archives_item_layout":"default"};
			</script>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="nav-footer"><ul class="list-inline font-nav"><li id="menu-item-76" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-76"><a href="index.php">TRANG CHỦ</a></li>

							<li id="menu-item-78" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-78"><a href="manga/index.php">XEM SAU</a></li>
...
<script type='text/javascript' src='wp-content/plugins/madara-core/assets/js/manga-search4d2c.js?ver=5.2.4'></script>
<script type='text/javascript'>
	/* <![CDATA[ */
...
<!-- Mirrored from demo.mangabooth.com/?s=&post_type=wp-manga by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2019 19:00:41 GMT -->
</html>